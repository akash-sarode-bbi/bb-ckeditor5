...
export default class LinkUI extends Plugin {
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<select class="form-select mb-3" id="linkType">
								...
								<option value="abbreviation" id="abbreviationSelectInput">Abbreviation Link</option>
								<option value="external" id="externalSelectInput">External Link</option>
								<option value="internal" id="internalSelectInput">Internal Link</option>
								<option value="reference" id="referenceSelectInput">Reference Link</option>
							</select>
	...
	_requestToc() {
		...
		tocResponse
			...
			.catch( error => {
				// disabled internal option in select dropdown
				const internalElement = document.getElementById( 'internalSelectInput' );
				if ( internalElement ) {
					internalElement.disabled = true;
				}
	...
	_requestAbbreviation() {
		...
		abbreviationResponse
			...
			.catch( error => {
				// disabled abbreviation option in select dropdown
				const abbreviationElement = document.getElementById( 'abbreviationSelectInput' );
				if ( abbreviationElement ) {
					abbreviationElement.disabled = true;
				}
	...
	_requestReference() {
		...
		referenceResponse
			...
			.catch( error => {
				// disabled reference option in select dropdown
				const referenceElement = document.getElementById( 'referenceSelectInput' );
				if ( referenceElement ) {
					referenceElement.disabled = true;
				}
